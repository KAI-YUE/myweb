...
[Reflections on product value and AI](/writing/what-remains-valuable/)
...
- Developed autoencoder-based hand-pose reconstruction in follow-up collaboration, informing later [USENIX Security 2023](https://rogattack.netlify.app) research.
...
- Applied insights from video coding to later [predictive-coding research for federated learning](https://predfl.netlify.app/) (IEEE JSTSP 2022).
...
- **ICML 2025:** [NTK-DFL: Enhancing Decentralized Federated Learning in Heterogeneous Settings via Neural Tangent Kernel](https://proceedings.mlr.press/v267/thompson25a.html).
