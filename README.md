...
## Current snapshot — September 18, 2026

- The refreshed site was deployed from the generated `public/` repository at
  commit `0d00c3c`.
- The source repository was consolidated into a clean root commit after the
  content, résumé positioning, and deployment were reviewed.
- Tranquilpeak is tracked as the `themes/tranquilpeak` Git submodule. Clone with
...
The generated site is pushed to `KAI-YUE/website`; the September 18 deployment
was visible at the configured Netlify URL.
